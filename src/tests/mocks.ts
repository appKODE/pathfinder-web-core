import {
  DataResolver, DataStorage, DataUrl, Spec, UrlSpec,
} from '../types';
...
export const parsedUrl:DataUrl = {
  baseUrl, fragment: 'fragment', path: '/user/v2/content/1/', query: new URLSearchParams('group=admin'),
};

export const url2 = 'https://domain.dev/user/v2/content/1/';
export const parsedUrl2:DataUrl = {
  baseUrl, path: '/user/v2/content/1/', query: new URLSearchParams(''),
};

export const url3 = baseUrl;
export const parsedUrl3:DataUrl = {
  baseUrl, path: '', query: new URLSearchParams(''),
};
